...
export default function Hero() {
  return (
    <section className="flex flex-col justify-center items-center h-screen lg:h-[70vh] relative py-20 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900 overflow-hidden">
      <div className="container px-4 text-center relative z-10 flex justify-between">
        <ComputersCanvas />
        <motion.div
        ...
        >
          <h1 className="text-5xl font-bold text-left mb-4 text-gray-800 dark:text-gray-100">
            Deemanth Poonacha
          </h1>
          <h2 className="text-2xl text-left mb-8 text-gray-600 dark:text-gray-300">
            Full Stack Developer
          </h2>
          <p className="text-lg text-left mb-8 max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
